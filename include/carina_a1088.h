...
typedef void (*CarinaA1088SuspendCallBackType)(int);

///
/// callback value, 0: suspend, 1: wake up
/// \return 0:success other:fail
CARINA_A1088_EXPORT int carina_a1088_set_hmd_state_callback(CarinaA1088SuspendCallBackType hmd_state_callback);
